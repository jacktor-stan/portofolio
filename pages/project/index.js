          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-1/2 mb-5">
              <p className="text-medium font-medium text-secondary md:text-lg">
               Di waktu luang saya membuat beberapa project dibawah ini untuk belajar sambil mendapatkan penghasilan dari penjualan fitur premium, 
               dimulai dari project murni yang dibuat dari 0 sampai project hasil fork dengan developer lain (dengan izin)
              </p>
            </div>
